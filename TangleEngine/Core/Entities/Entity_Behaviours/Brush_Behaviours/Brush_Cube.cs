...
namespace TangleEngine.Entities.Entity_Behaviours.Brush_Behaviours
{
    public class Brush_Cube : GeometricPrimitive<VertexDualTex>
    {
        ...
        {
            effect.Parameters["FrontTexture"].SetValue(Parent.GetProperty<Texture2D>("FrontTex").Value);
            effect.Parameters["BackTexture"].SetValue(Parent.GetProperty<Texture2D>("BackTex").Value);
            effect.Parameters["RightTexture"].SetValue(Parent.GetProperty<Texture2D>("RightTex").Value);
            effect.Parameters["LeftTexture"].SetValue(Parent.GetProperty<Texture2D>("LeftTex").Value);
            effect.Parameters["BottomTexture"].SetValue(Parent.GetProperty<Texture2D>("BottomTex").Value);
            effect.Parameters["TopTexture"].SetValue(Parent.GetProperty<Texture2D>("TopTex").Value);
